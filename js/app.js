...
// Добавляем классы headery в зависимости от открытой страницы
document.addEventListener('DOMContentLoaded', () => {
	const wrapper_data = document.querySelector('.wrapper');
	const header = document.querySelector('.header');
	console.log(wrapper_data.dataset.page);
	if (wrapper_data.dataset.page == 'dark') {
		header.classList.add('_dark');
	}
	if (wrapper_data.dataset.page == 'light') {
